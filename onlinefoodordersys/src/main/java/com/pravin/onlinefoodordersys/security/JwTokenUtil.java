package com.pravin.onlinefoodordersys.security;
...
public class JwTokenUtil implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8847919056031141848L;
	...
	// Read secret key from application.properties file
	@Value("${jwt.secret}")
	private String secret;

	// Read expiration from application.properties file
	...
	// Before this we need to create jwtUser class
